...
Entre la información que incluye una factura son: el _codigo_factura_ que es la _primary key_ de la tabla, el codigo_compra que se refiere dicha factura , numero_tarjeta del cliente, además el _codigo_comercio_ y el _monto_.
