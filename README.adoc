...
Otras de las tablas que tendremos a lo largo del trabajo práctico son: *Tabla cliente* es la persona que reliza la compra, *Tabla tarjeta* es con la cual se efectua el pago, *Tabla comercio* lugar elegido para realizar sus compras, *Tabla compra* es la que tiene los datos de la compra realizada, *Tabla factura* es el ticket que se le genera al cliente cuando terminó de pagar,, que más adelante explicaremos de manera específica dichas tablas. 
