...
Al comienzo, la realización de las tablas lo ejecutamos de forma sencilla, sin embargo, tuvimos dificultades con algunos conceptos referidos a la compra y su facturación. Habiamos incluido el ticket de una compra pero no tuvimos en cuenta el detalle de dicha compra, y además, no habiamos realizado la tabla del resumen de la tarjeta, cuya confección era un requisito del enunciado.
...
== Conclusiones
Finalmente este trabajo práctico nos resulto satisfactorio ya que pudimos resolver  las dificultades que tuvimos  con los aspectos referidos a la compra y su facturación. Tuvimos en cuenta el detalle de la factura como así también el resumen de la tarjeta. Para ello agregamos la *tabla detalle* y también *tabla resumen*  .
